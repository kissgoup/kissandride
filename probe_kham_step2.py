...
TARGET_URL = "https://kham.com.tw/application/UTK02/UTK0204_.aspx?PERFORMANCE_ID=P1D430L4&PRODUCT_ID=P1D3G65D"
...
async def main():
    ...
    async with AsyncWebCrawler(config=browser_cfg) as crawler:
        ...
        if result.success:
            ...
            with open("kham_step2.html", "w", encoding="utf-8") as f:
                f.write(html)
            print("saved -> kham_step2.html")
            print("---- head 800 ----")
            print(html[:800])
        else:
